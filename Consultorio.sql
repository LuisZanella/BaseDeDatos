...
CREATE TABLE Vocacion(
    CodigoVocacion INT PRIMARY KEY IDENTITY,
    Vocacion VARCHAR (100) NOT NULL
)
GO
--CREACION DE LA TABLA VocacionMedico
CREATE TABLE VocacionMedico(
    ...
    CodigoVocacion INT NOT NULL FOREIGN KEY REFERENCES Vocacion(CodigoVocacion) ON DELETE CASCADE ON UPDATE CASCADE
)
GO
